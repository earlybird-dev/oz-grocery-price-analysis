...
def get_woolies_cat_l3(driver, woolies_cat_l2):
    ...
    for index, cat_l2 in woolies_cat_l2.iterrows():
        ...
        for item in category_items:
            ...
            cat_dict["cat_l3_name"] = item.find_element(By.CSS_SELECTOR, "span.chip-text").text
...
def load_data(*args, **kwargs):
    ...
    woolies_cat_l2 = load_data_from_big_query()
    print("woolies_cat_l2", woolies_cat_l2)

    # Get woolies level 3 categories
    woolies_cat_l3 = get_woolies_cat_l3(driver, woolies_cat_l2)
